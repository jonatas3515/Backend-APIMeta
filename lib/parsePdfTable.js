...
// Desabilita worker para ambiente serverless
...
async function parsePdfToText(buffer) {
  ...
  // Limita a 10 paginas para evitar timeout em PDFs grandes
  const maxPages = Math.min(pdf.numPages, 10);
  console.log(`[PARSE-PDF] Processando ${maxPages} de ${pdf.numPages} paginas`);
