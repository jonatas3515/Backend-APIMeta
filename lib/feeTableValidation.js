...
export function validatePreview(data) {
  ...
  const recognized = {
    area: findColumn(headers, ['area', 'area_juridica', 'area juridica', 'legal_area', 'areajuridica']),
    tipo: findColumn(headers, ['tipo', 'case_type', 'tipo_caso', 'tipo caso', 'tipocaso']),
    servico: findColumn(headers, ['servico', 'service', 'nome', 'item', 'descricao', 'descrição']),
    minimo: findColumn(headers, ['minimo', 'mínimo', 'min', 'min_amount', 'valor_minimo']),
    sugerido: findColumn(headers, ['sugerido', 'suggested', 'sugestao', 'sugestão', 'suggested_amount']),
