...
import { dateToWords } from './formatters';
...
export function generateDocument(templateId, data) {
  ...
  // Converte datas de contrato/documento para extenso (ex: 13/08/2026 -> 13 de agosto de 2026)
  const processedData = { ...data };
  for (const field of template.fields) {
    if ((field.field === 'data' || field.field.endsWith('_data')) && processedData[field.field]) {
      processedData[field.field] = dateToWords(processedData[field.field]);
    }
  }
