...
export default function GeneratedDocumentsPanel({ caseId, conversationId, onClose }) {
  ...
  return (
    <div className="space-y-4">
      ...
      {loading ? (
        ...
        <p className="text-sm text-gray-500">Nenhum documento gerado para este caso.</p>
      ) : (
