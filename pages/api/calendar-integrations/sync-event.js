...
async function handler(req, res) {
  ...
  const { event_id, provider } = req.body || {};
  ...
  // Fase 2: buscar integração, refresh token se necessário, enviar para API externa
  return res.status(501).json({
    success: false,
    message: 'Sincronização de evento individual será implementada na Fase 2.'
  });
}
